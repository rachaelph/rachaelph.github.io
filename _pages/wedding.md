...
permalink: /wedding/
title: "Our Wedding"
feature_image: "/assets/images/beach_wedding.jpg"
---

<style>
  /* Elegant wedding page styling */
  .wedding-page {
    background: linear-gradient(to bottom, #f0f8ff 0%, #e6f3f5 50%, #fff9f0 100%);
...
<div class="wedding-page" style="padding: 20px 0; margin: -20px -40px; background: linear-gradient(to bottom, #f0f8ff 0%, #e6f3f5 50%, #fff9f0 100%);">
...
<!-- Honeymoon Fund Section with Feature Image -->
<div style="background: linear-gradient(rgba(44, 95, 111, 0.85), rgba(44, 95, 111, 0.85)), url('/assets/images/costa_rica2.jpg'); background-size: cover; background-position: center; padding: 60px 20px; margin: 50px -40px;">
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; margin: 30px 0;">
  ...
  <img src="/assets/images/costa_rica3.jpg" alt="Costa Rica" style="width: 100%; border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.3);">
  <img src="/assets/images/costa_rica4.jpg" alt="Costa Rica" style="width: 100%; border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.3);">
</div>

<p style="font-size: 1.1em; line-height: 1.8;">The greatest gift to us is your presence on our special day! However, if you would like to contribute to our honeymoon, we would be so grateful. We're planning an amazing 10-day adventure to <strong>Costa Rica</strong>!</p>
...
<div style="background: rgba(255, 255, 255, 0.95); padding: 30px; border-radius: 10px; margin: 30px 0; color: #333;">
  
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px;">
    
    <div style="text-align: center; padding: 15px;">
      <p style="font-size: 1.1em; margin-bottom: 10px; color: #333;"><strong>💙 Venmo</strong></p>
      <p style="font-size: 1.3em; color: #008CFF; font-weight: bold;">@Rachael-Phillips-13</p>
      <img src="/assets/images/venmo_qrcode.jpg" alt="Venmo QR Code" style="width: 150px; height: 150px; margin: 10px auto; display: block;">
    ...
    <div style="text-align: center; padding: 15px;">
      <p style="font-size: 1.1em; margin-bottom: 10px; color: #333;"><strong>💚 Zelle</strong></p>
      <p style="font-size: 1.1em; color: #6D1ED4; font-weight: bold;">rachael.phillips23@gmail.com</p>
    </div>
    
    <div style="text-align: center; padding: 15px;">
      <p style="font-size: 1.1em; margin-bottom: 10px; color: #333;"><strong>💵 CashApp</strong></p>
      <p style="font-size: 1.3em; color: #00C244; font-weight: bold;">$rachaelaps</p>
    </div>
    
    <div style="text-align: center; padding: 15px;">
      <p style="font-size: 1.1em; margin-bottom: 10px; color: #333;"><strong>💳 PayPal</strong></p>
      <p style="font-size: 1.1em; color: #003087; font-weight: bold;">rachael.phillips23@gmail.com</p>
    </div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin: 30px 0;">
  <img src="/assets/images/beach_wedding.jpg" alt="Venue" style="width: 100%; border-radius: 10px;">
  <img src="/assets/images/madeira_beach.jpg" alt="Madeira Beach" style="width: 100%; border-radius: 10px;">
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 15px; margin: 30px 0;">
  ...
  <img src="/assets/images/costa_rica2.jpg" alt="Costa Rica" style="width: 100%; border-radius: 10px;">
...
**Prefer to give a check?**  
You can make checks payable to **Rachael Phillips** or **Jared Smith** and give them to us at the wedding or mail them to us (contact us for mailing address).

### Help Us Experience Costa Rica 🇨🇷

Here's what we're planning for our 10-day adventure:
